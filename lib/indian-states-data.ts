...
export const indianStatesData: StateData[] = [
  // Andhra Pradesh (synced from andhra-pradesh-data.ts)
  {
    ...
    districts: [
      ...
      { district: 'Konaseema', mandals: ['Allavaram', 'Amalapuram', 'Atreyapuram', 'I.Polavaram', 'Kakinada (rural)', 'Kakinada (urban)', 'Kapileswarapuram', 'Katrenikona', 'Kothapeta', 'Malikipuram', 'Mummidivaram', 'P.Gannavaram', 'Rampachodavaram', 'Ravulapalem', 'Rayavaram', 'Sakhinetipalle', 'Thallarevu', 'Uppalaguptam'] },
